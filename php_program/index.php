...
$email = $client_name = $client_Surname = $phoneNum = $password = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT id, email, client_name, client_Surname,phoneNum, password FROM users WHERE email = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $email, $client_name, $client_Surname, $phoneNum, $hashed_password);
...
?>
<?php
echo '<script>var src = localStorage.getItem("key");</script>';
